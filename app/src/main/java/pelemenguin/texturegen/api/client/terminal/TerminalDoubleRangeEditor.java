...
public class TerminalDoubleRangeEditor {
    ...
    public TerminalDoubleRangeEditor(DoubleRange range) {
        this.range = range;
    }

    public TerminalDoubleRangeEditor fixRange(double min, double max) {
    ...
    private String getBar(double min, double max) {
        int barLength = 50;
    ...
    public DoubleRange loop(TerminalMenuContext context) {
        ...
        while (true) {
            if (this.fixedRange) {
                ...
                double d = this.range.upperBound - this.range.lowerBound;
